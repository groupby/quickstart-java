...
<form id="cookieForm">
  ...
  <c:if test="${!empty customerId}">
    <a style="margin:5px;float: right" target="_blank" id="commandCenterLink" href="https://${customerId}.groupbycloud.com/admin/keyManagement.html">Command Center</a>
  </c:if>
  ...
  <input type="text" name="biasingProfile" id="biasingProfile" placeholder="Biasing Profile" style="width:100px">
  <input type="text" name="language" id="language" placeholder="Language" style="width:80px">
    <br><input type="text" name="fields" id="fields" placeholder="Field List, comma separated" style="width:750px;margin-top:10px">
  <br />
</form>
</div>
<form id="form" accept-charset="UTF-8" action="<c:url value="${b:toUrlAdd('default', results.query, results.selectedNavigation, 'selected', null) }"/>">
  ...
  <a id="clear" href="<c:url value="/index.html"/>">Clear All</a>
</form>
