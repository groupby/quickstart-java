<div class="header">
  <form id="cookieForm">
    <div class="info-bar row">
      <div class="logo-area">
        <img src="/images/logo.png" />Reference App
      </div>
      <div class="cac-area grow">
        <span>Customer:</span><b>${empty cookie.customerId.value ? 'not set' : cookie.customerId.value}</b>
        <span>Area:</span><b>${empty cookie.area.value ? 'Production' : cookie.area.value}</b>
        <span>Collection:</span><b><a>${empty cookie.collection.value ? 'default' : cookie.collection.value}</a></b>
      </div>
      <div>
        <a href="javascript:;" onclick="showForm()" class="btn icon">
        ...
        <div class="row">
          <div class='_50'>
            <fieldset>
              ...
              <input type="text" name="clientKey" id="clientKey" placeholder="Client Key" class="input--medium">
        ...
        <div class="row">
          ...
          <fieldset>
            ...
            <div class="row">
              ...
              <input type="text" name="pageSize" id="pageSize" placeholder="Page Size (max 100)" class="input--small">
              <div class="checkbox-area">
          ...
          <fieldset>
            ...
            <div class="column">
              ...
              <input title="Custom Parameters, name=value & separated" type="text" name="customUrlParameters" id="customUrlParameters" placeholder="Custom Parameters" class="input--large">
            </div>
