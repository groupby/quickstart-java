...
<form id="cookieForm">
  ...
  <td>
      ...
      <fieldset>
          ...
          <input type="text" name="excludedNavigations" id="excludedNavigations" placeholder="Excluded Navigations" style="width:125px"><br>
      </fieldset>
  </td><td>
      <fieldset>
          <legend>Result Control</legend>
          <input type="text" name="sortField" id="sortField" placeholder="Sort Field" style="width:100px"><br>
