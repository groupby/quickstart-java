...
<table width="100%">
    ...
    <textarea style="width:200px;height:100px;font-size:10px;" id="strategy${b.index}" class="strategyInput" placeholder"Match Strategy"><c:out value="${URLDecoder.decode(matchStrategies[b.index], 'UTF-8')}"/></textarea>
    <br>
